  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="relative" ref={menuRef}>
        ...
        >
          <i className="ph-duotone ph-funnel-simple" style={{ fontSize: 15 }} />
          {filtre !== t.tous ? filtre : t.filtres}
        </button>

        {menuFiltre && (
          <div className="absolute left-0 mt-2 w-56 rounded-xl bg-surface-low border border-outline-variant py-2 z-40">
