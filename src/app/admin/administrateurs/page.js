...
export default function AdminAdministrateurs() {
  ...
  return (
    <main className="px-6 md:px-12 py-12 max-w-3xl">
      ...
      {/* Créer un admin */}
      <form onSubmit={creerAdmin} className="bg-surface-low border border-outline-variant rounded-xl p-6 mb-8 flex flex-col gap-4">
        <h2 className="title-lg text-primary flex items-center gap-2">
          <i className="ph-duotone ph-plus" style={{ fontSize: 18 }} /> Inviter un administrateur
        </h2>
        ...
        {identifiants && (
          <div className="rounded-lg border border-outline/30 bg-primary/5 p-4">
            <p className="label-md text-primary mb-2 flex items-center gap-2">
              <i className="ph-duotone ph-key" style={{ fontSize: 14 }} /> Identifiants à transmettre
            </p>
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-primary-container/20 flex items-center justify-center">
                <i className="ph-duotone ph-shield text-primary" style={{ fontSize: 18 }} />
              </div>
              ...
              >
                <i className="ph-duotone ph-sliders-horizontal" style={{ fontSize: 14 }} /> Attributions
              </button>
              {a.id !== moi && (
                <button
                ...
                >
                  <i className="ph-duotone ph-user-minus" style={{ fontSize: 14 }} /> Retirer
                </button>
              )}
            </div>
      ...
      {/* Mon mot de passe */}
      <form onSubmit={changerMotDePasse} className="bg-surface-low border border-outline-variant rounded-xl p-6 flex flex-col gap-4">
        <h2 className="title-lg text-primary flex items-center gap-2">
          <i className="ph-duotone ph-key" style={{ fontSize: 18 }} /> Mon mot de passe
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
